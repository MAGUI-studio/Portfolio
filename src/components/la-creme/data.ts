export const images = {
  hero: "/images/lacreme/hero.webp",
  bolo_morango: "/images/lacreme/bolo_morango.mp4",
  redvelvet: "/images/lacreme/naked_cake_morango.webp",
  torta_frutas_vermelhas: "/images/lacreme/torta_frutas_vermelhas.webp",
  torta_ferrero: "/images/lacreme/torta_ferrero.webp",
  caixa_macarons: "/images/lacreme/caixa_macaron.webp",
  torta_limao: "/images/lacreme/torta_limao.webp",
  flor_de_baunilha: "/images/lacreme/flor_de_baunilha.webp",
  brownie_nozes: "/images/lacreme/brownie_nozes.webp",
  macaron_pistache: "/images/lacreme/macaron_pistache.webp",
  mil_folhas_de_baunilha: "/images/lacreme/mil_folhas_de_baunilha.webp",
  cookies: "/images/lacreme/cookies.webp",
  processo_la_creme: "/images/lacreme/processo_la_creme.webp",
  cupcake_morango: "/images/lacreme/cupcake_morango.webp",
  copo_da_felicidade: "/images/lacreme/copo_da_felicidade.webp",
  floresta_negra: "/images/lacreme/floresta_negra.webp",
  embalagem_bolo: "/images/lacreme/embalagem_bolo.webp",
  embalagem_doce: "/images/lacreme/embalagem_doce.webp",
  embalagem_docinhos: "/images/lacreme/embalagem_docinhos.webp",
  embalagem_sobremesa: "/images/lacreme/embalagem_sobremesa.webp",
} as const;

export const video = "/images/lacreme/bolo_morango.webm";
