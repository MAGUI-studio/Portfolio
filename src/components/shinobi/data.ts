...
export const shinobiFlavors: ShinobiFlavor[] = [
  {
    ...
    description: "Perfil vermelho, intenso e facil de beber sem perder atitude.",
    accent: "#e73543",
  ...
  },
  {
    ...
    description: "Acidez brilhante, final doce e uma assinatura que corta o calor.",
    accent: "#d99d18",
  ...
  },
  {
    ...
    description: "Fruta escura, corpo cheio e presenca forte para viradas longas.",
    accent: "#a733ca",
...
export const shinobiSignals = [
  ...
  ["Resistencia", "Bebida gelada, carbonatada e pronta para acompanhar o corre."],
