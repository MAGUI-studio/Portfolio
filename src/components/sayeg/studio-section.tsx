      ...
      <div>
        <div className="grid gap-8 pt-5 lg:grid-cols-12">
          <SayegReveal className="pb-2 lg:col-span-4 lg:pt-16">
            ...
            <Link href={sayegWhatsapp} target="_blank" rel="noreferrer" className="group mt-7 inline-flex items-center gap-3 border-b border-[#673d35]/70 pb-1 text-[10px] font-bold uppercase tracking-[0.2em] text-[#673d35] transition-colors hover:border-[#35231f] hover:text-[#35231f] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#8d594d] focus-visible:ring-offset-4">
          ...
          <SayegImageReveal delay={0.08} className="relative lg:col-span-8">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-12 md:items-end">
          <SayegImageReveal className="relative md:col-span-7">
          ...
          <SayegReveal delay={0.08} className="border-l border-[#262323]/14 pl-6 md:col-span-4 md:col-start-9 md:pb-7">
