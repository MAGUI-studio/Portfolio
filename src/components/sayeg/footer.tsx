  ...
  return (
    <footer className="bg-[#202427] text-white">
      <div className="grid gap-10 px-5 py-12 md:grid-cols-[0.58fr_0.42fr] md:px-10 md:py-16 lg:px-14">
        <div>
          <Link href="#inicio" aria-label="Beatriz Sayeg, voltar ao início" className="inline-flex transition-opacity hover:opacity-70 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#e4c9b9] focus-visible:ring-offset-4 focus-visible:ring-offset-[#202427]">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          <div>
            ...
            <nav className="mt-5 grid gap-3 text-sm text-white/54">
              {sayegNav.map((item) => <Link key={item.href} href={item.href} className="w-fit transition-colors hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[#e4c9b9] focus-visible:ring-offset-4 focus-visible:ring-offset-[#202427]">{item.label}</Link>)}
            </nav>
          </div>
          <div>
            ...
            <div className="mt-5 grid gap-3 text-sm text-white/54">
              ...
              <Link href={sayegWhatsapp} target="_blank" rel="noreferrer" className="group inline-flex w-fit items-center gap-2 transition-colors hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[#e4c9b9] focus-visible:ring-offset-4 focus-visible:ring-offset-[#202427]">WhatsApp do estúdio <ArrowUpRight size={13} className="transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" /></Link>
            </div>
          </div>
        </div>
      </div>
