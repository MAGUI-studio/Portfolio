...
export function SayegClosingSection() {
  return (
    <section className="relative overflow-hidden bg-[#202427] px-5 pb-20 pt-32 text-white [clip-path:polygon(0_4rem,100%_0,100%_100%,0_100%)] md:px-10 md:pb-28 md:pt-40 md:[clip-path:polygon(0_6rem,100%_0,100%_100%,0_100%)] lg:px-14 lg:pb-36 lg:pt-44">
      <div className="relative grid overflow-hidden lg:grid-cols-[0.16fr_0.84fr]">
        ...
        <div className="relative overflow-hidden px-6 py-14 md:px-12 md:py-20 lg:px-16 lg:py-24">
          <p
          ...
          <div className="relative mt-8 flex flex-wrap items-center gap-6 pt-7">
            ...
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-3 border-b border-white/72 pb-1 text-[11px] font-medium tracking-wide text-white transition-colors duration-300 hover:border-[#e4c9b9] hover:text-[#e4c9b9]"
            >
              Falar com o estúdio <ArrowUpRight size={15} />
            </Link>
          </div>
        </div>
      </div>
