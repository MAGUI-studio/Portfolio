          ...
          >
            ...
            <div className="mt-9 grid gap-3">
              <Link
                ...
                className="kroma-cta inline-flex items-center justify-center gap-3 bg-[#FFBC4F] p-5 text-sm font-bold text-[#2A2A2A] transition duration-300 hover:-translate-y-1 hover:bg-white"
              >
                Chamar no WhatsApp
